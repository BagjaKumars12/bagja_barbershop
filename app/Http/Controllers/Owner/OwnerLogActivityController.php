...
class OwnerLogActivityController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('owner.log_activity.index', compact('logs', 'roles', 'modules'));
    }

    public function show($id)
    {
        $log = ActivityLog::findOrFail($id);
        return view('owner.log_activity.detail', compact('log'));
    }
}