...
<div class="space-y-6" x-data="bookingManager()">
    ...
    <div class="relative max-w-md">
        <form method="GET" action="{{ route('owner.bookings.index') }}" class="relative">
            ...
            @if(request('search'))
                <a href="{{ route('owner.bookings.index') }}" class="absolute right-3 top-3 text-gray-400 hover:text-gray-600"><i class="fas fa-times"></i></a>
            @endif
        </form>
    </div>
