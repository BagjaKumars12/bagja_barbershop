            ...
            <div class="p-4">
                ...
                <nav class="space-y-2">
                    <a href="{{ route('owner.dashboard') }}"
                       ...
                       :class="{
                           'bg-[#D4AF37] text-white': activeMenu === 'owner.dashboard',
                           'text-gray-300 hover:bg-gray-700': darkMode && activeMenu !== 'owner.dashboard',
                           'text-gray-700 hover:bg-gray-100': !darkMode && activeMenu !== 'owner.dashboard'
                       }">
                    ...
                    class="flex items-center space-x-3 px-4 py-2 rounded-lg transition"
                    :class="{
                        'bg-[#D4AF37] text-white': activeMenu === 'owner.users',
                        'text-gray-300 hover:bg-gray-700': darkMode && activeMenu !== 'owner.users',
                        'text-gray-700 hover:bg-gray-100': !darkMode && activeMenu !== 'owner.users'
                    }">
                    ...
                    class="flex items-center space-x-3 px-4 py-2 rounded-lg transition"
                    :class="{
                        'bg-[#D4AF37] text-white': activeMenu === 'owner.services.index',
                        'text-gray-300 hover:bg-gray-700': darkMode && activeMenu !== 'owner.services.index',
                        'text-gray-700 hover:bg-gray-100': !darkMode && activeMenu !== 'owner.services.index'
                    }">
                    ...
                    class="flex items-center space-x-3 px-4 py-2 rounded-lg transition"
                    :class="{
                        'bg-[#D4AF37] text-white': activeMenu === 'owner.customers.index',
                        'text-gray-300 hover:bg-gray-700': darkMode && activeMenu !== 'owner.customers.index',
                        'text-gray-700 hover:bg-gray-100': !darkMode && activeMenu !== 'owner.customers.index'
                    }">
                        <i class="fas fa-user-friends w-5"></i>
                        <span>Customers</span>
                    </a>
                    <a href="{{ route('owner.barbers.index') }}"
                    class="flex items-center space-x-3 px-4 py-2 rounded-lg transition"
                    :class="{
                        'bg-[#D4AF37] text-white': activeMenu === 'owner.barbers.index',
                        'text-gray-300 hover:bg-gray-700': darkMode && activeMenu !== 'owner.barbers.index',
                        'text-gray-700 hover:bg-gray-100': !darkMode && activeMenu !== 'owner.barbers.index'
                    }">
                    ...
                    class="flex items-center space-x-3 px-4 py-2 rounded-lg transition"
                    :class="{
                        'bg-[#D4AF37] text-white': activeMenu === 'owner.bookings.index',
                        'text-gray-300 hover:bg-gray-700': darkMode && activeMenu !== 'owner.bookings.index',
                        'text-gray-700 hover:bg-gray-100': !darkMode && activeMenu !== 'owner.bookings.index'
                    }">
