...
<div x-data="logManager()" x-init="init()" class="space-y-6">
    <div class="rounded-lg shadow p-6" :class="darkMode ? 'bg-gray-800' : 'bg-white'">
        ...
        <form method="GET" activity="{{ route('admin.log_activity.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="flex gap-2 md:col-span-5">
                ...
                <a href="{{ route('admin.log_activity.index') }}" class="px-4 py-2 border rounded-lg transition"
            ...
            <tbody class="divide-y" :class="darkMode ? 'divide-gray-700' : 'divide-gray-200'">
                ...
                <tr :class="darkMode ? 'bg-gray-800' : 'bg-white'">
                    ...
                    <td class="px-4 py-3 text-center">
                        <a href="{{ route('admin.log_activity.show', $log->id) }}" class="text-blue-600 hover:text-blue-800">Lihat</a>
                    </td>
                </tr>
                @empty
                <tr>
